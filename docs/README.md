...
Root project overview lives in `../README.md`.
This file indexes deeper technical and planning docs.
...
A folder split (`docs/current` + `docs/history`) is still optional.
For now, keeping docs at top level avoids churn while implementation is moving quickly.
