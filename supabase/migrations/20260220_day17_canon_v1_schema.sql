...
alter table public.canonical_foods
  validate constraint canonical_foods_default_state_check;
...
alter table public.canonical_variant_dimensions
  ...
  check (value_type in ('enum', 'number')) not valid;

alter table public.canonical_variant_dimensions
  validate constraint canonical_variant_dimensions_value_type_check;
